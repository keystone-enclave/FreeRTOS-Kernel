 ...
 *			the time to pvPortMalloc(3) storage and to compute the
...
void Proc0()
{
	...
	PtrGlbNext = (RecordPtr) pvPortMalloc(sizeof(RecordType));
	PtrGlb = (RecordPtr) pvPortMalloc(sizeof(RecordType));
